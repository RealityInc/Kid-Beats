export async function analyzeVibe({ apiKey, audioBase64, mimeType, mockMode = false }) {
  if (mockMode || !apiKey) {
    return { transcript: null, mood: 'happy', energy: 'medium', theme: 'playful adventure', suggestedStyles: ['kids pop', 'bounce'], safetyFlags: [] };
  }
  try {
